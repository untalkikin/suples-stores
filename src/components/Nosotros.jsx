                    ...
                    <div className="p-2">
                        <div className="text-gray-300 my-3">
                            <p className="text-justify leading-7 w-11/12 mx-auto">
                                ...
                                incursionando ahora en el e-comerce, con una gran 
                                variedad de suplmentos deportivos como: Proteinas,
                                Creatinas, Vitaminicos y Farmacos, para que lleves
                                tu cuerpo a otro nivel.
                            </p>
